                            ...
                            <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                                <div className="flex-1">
                                    ...
                                    <blockquote className="flex-1 mt-8">
                                        <p className="text-lg leading-relaxed text-gray-900 font-pj">“I've been using Your Website Name for my daily horoscope, and the insights are always spot on. It helps me start my day with confidence!”</p>
                                    </blockquote>
                                </div>
                                ...
                                <div className="flex items-center mt-8">
                                    ...
                                    <div className="ml-4">
                                        <p className="text-base font-bold text-gray-900 font-pj">Sarah M</p>
                        ...
                        <div className="flex flex-col overflow-hidden rounded-2xl shadow-xl">
                            <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                                <div className="flex-1">
                                    ...
                                    <blockquote className="flex-1 mt-8">
                                        <p className="text-lg leading-relaxed text-gray-900 font-pj">“The personalized Kundli analysis was incredibly detailed and accurate. It provided me with a new perspective on my life's path.”</p>
                                    </blockquote>
                                </div>
                                ...
                                <div className="flex items-center mt-8">
                                    ...
                                    <div className="ml-4">
                                        <p className="text-base font-bold text-gray-900 font-pj">Rajesh K.</p>
                        ...
                        <div className="flex flex-col overflow-hidden rounded-2xl shadow-xl">
                            <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                                <div className="flex-1">
                                    ...
                                    <blockquote className="flex-1 mt-8">
                                        <p className="text-lg leading-relaxed text-gray-900 font-pj">“The Vedic remedies suggested have made a significant positive impact on my life. I feel more balanced and at peace.
                                        ”</p>
                                    </blockquote>
                                </div>
                                ...
                                <div className="flex items-center mt-8">
                                    ...
                                    <div className="ml-4">
                                        <p className="text-base font-bold text-gray-900 font-pj"> Anita S</p>
                        ...
                        <div className="flex flex-col overflow-hidden rounded-2xl shadow-xl">
                            <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                                <div className="flex-1">
                                    ...
                                    <blockquote className="flex-1 mt-8">
                                        <p className="text-lg leading-relaxed text-gray-900 font-pj">“Learning about my zodiac sign's traits has helped me understand myself and my relationships better. Highly recommend this site!
                                        ”</p>
                                    </blockquote>
                                </div>
                                ...
                                <div className="flex items-center mt-8">
                                    <img className="flex-shrink-0 object-cover rounded-full w-11 h-11" src="https://cdn.rareblocks.xyz/collection/clarity/images/testimonial/4/avatar-female.png" alt="" />
                                    <div className="ml-4">
                                        <p className="text-base font-bold text-gray-900 font-pj"> Ajay P.</p>
                                        <p className="mt-0.5 text-sm font-pj text-gray-600">Graphic Designer</p>
                                    </div>
                                </div>
                            </div>
